...
class FeatureGenerator(BaseEstimator, TransformerMixin):
    ...
    def __init__(self, add_bedroom_per_room: bool = True,
                 total_rooms_ix = 3, total_bedrooms_ix = 4,
                 population_ix = 5, households_ix = 6,
                 columns = None):
        try:
...
class DataTransformation:
    ...
    def get_data_transformer_object(self) -> ColumnTransformer:
        try:
            ...
            num_pipeline = Pipeline( steps = [
                ...
                ('feature_generator', FeatureGenerator(add_bedroom_per_room = self.data_transformation_config.add_bedrooms_per_room,
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact: 
        try:
            logging.info(f"Obtaining Data preprocessing object")
            ...
            logging.info(f"Splitting the data into input and target feature for both train and test.")
            ...
            logging.info(f"Saving transformed train and test data as numpy array.")
            save_numpy_array_data(file_path = transformed_train_file_path, array =train_arr)
            save_numpy_array_data(file_path = transformed_test_file_path, array = test_arr)
            
            preprocessing_obj_file_path = self.data_transformation_config.preprocesssed_object_file_path
            ...
            data_transformation_artifact = DataTransformationArtifact(
                ...
                preprocesssed_object_file_path = preprocessing_obj_file_path
            )
